...
const YOUTUBE_TUTORIAL_URL = "https://youtube.com/@ukemedaniel2002?si=GgixlD0TlifQjd_t";
...
function TutorialBanner() {
  return (
    <div
      className="w-full rounded-2xl border mb-8 px-5 py-4 flex items-center justify-between gap-4 flex-wrap"
    ...
    >
      <div className="flex items-center gap-3.5 min-w-0">
        ...
        >
          <svg viewBox="0 0 24 24" fill="#ff4444" className="w-5 h-5">
      ...
      <a
        ...
        className="flex-shrink-0 flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-semibold text-white transition-all hover:opacity-90 active:scale-95"
      ...
      >
        <div className="px-7 py-7 flex flex-col gap-5">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <input
              type="text"
              placeholder="e.g. Mama's Kitchen Assistant"
              value={agentName}
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <textarea
              ...
              rows={3}
              className="w-full rounded-lg px-4 py-2.5 text-sm text-white outline-none resize-none"
        ...
        <div className="flex flex-col items-center text-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm leading-relaxed" style={{ color: "rgba(255,255,255,0.45)" }}>
              ...
              <span className="text-white font-medium">"{agent.name}"</span> and all its data
              including knowledge base and tools. This cannot be undone.
            </p>
          </div>
        </div>
              ...
              return (
                <div key={i} className="flex-1 flex flex-col items-center gap-1">
                  <div
                    ...
                    style={{
                      height: `${h}%`,
                      backgroundColor: v > 0 ? "#3b5bfc" : "rgba(255,255,255,0.06)",
                    }}
