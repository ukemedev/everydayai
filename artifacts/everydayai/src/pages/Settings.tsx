...
export default function Settings() {
  ...
  const [telegram, setTelegram] = useState<TelegramState>({
    botToken: "", chatId: "", savedBotToken: null, savedChatId: null, saving: false, removing: false,
  });
  ...
  async function handleSaveTelegram() {
    ...
    const { error } = await supabase.from("integrations").upsert(
      { user_id: user.id, provider: "telegram", access_token: botToken, refresh_token: chatId, expires_at: null },
  ...
  function setInputVal(providerId: string, val: string) {
                  ...
                  {connected && (
                    ...
                    >
                      ...
                      <button
                        ...
                        className="text-xs text-red-400/80 hover:text-red-400 transition-colors ml-3 flex-shrink-0 disabled:opacity-50"
                      >
              ...
              >
                ...
                <div className="flex flex-col gap-2">
                  <input
                    ...
                    className="w-full rounded-lg px-3 py-2 text-sm outline-none focus:border-[#3b5bfc] transition-colors"
                    style={inputStyle}
                  />
                  <div className="flex gap-2">
                    <input
